...
export default class SimpleTransformer implements TransformerPlugin<unknown, string, SimpleTransformerConfig> {
  ...
  async transform({ input }: ActionArgs<unknown, SimpleTransformerConfig>): Promise<string> {
    try {
